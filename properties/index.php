  ...
  <div id="center">
    <div class="text" style="min-height:600px; width:905px; padding-left:0px;">
      ...
      ?>
            <div class="titlelong">
              <div id="breadcrumbs">
<a href="http://<?php echo $file;?>">HOME</a> / <a href="http://<?php echo $file;?>properties.php">PROPERTIES FOR LEASE</a> / <?php echo strtoupper($r['states_name']);?> 
</div>
            </div>
      <?php
          }
    ...
    <div class="para2" style="position:absolute; bottom:40px; left:670px;border:10px solid #d6d6d6;">
